...
class ModelTestRegistry {
  public:
    ...
    void register_model(const std::string &name, ModelBuilderFunction builder_func, const ModelTestMetadata &metadata);
...
class ModelTestExecutor {
  ...
  public:
    explicit ModelTestExecutor(ModelTestRegistry &registry)
      : registry_(registry) {}
...
ModelTestMetadata
create_identifiability_metadata(const std::string &name,
...
ModelTestMetadata
create_classical_metadata(const std::string &name,
                          const std::string &description,
...
ModelTestMetadata
create_biological_metadata(const std::string &name,
                           const std::string &description,
                           const std::pair<double, double> &time_interval,
                           bool has_rational_functions = false);
...
ModelTestMetadata
create_simple_metadata(const std::string &name, const std::string &description, int expected_identifiable_count = -1);

} // namespace metadata_builders

// Global registry instance
extern ModelTestRegistry &
