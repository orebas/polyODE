...
TEST_F(ParameterEstimatorScenariosTest, DISABLED_SumTestSystem) {
...
// NOTE: The legacy SimpleModel and GlobalUnidentTest have been modernized and moved to 
// the systematic_model_tests.cpp framework as LegacySimpleModelModernized and 
// LegacyGlobalUnidentTestModernized. The old stub-based implementations have been 
// removed as they were using incomplete helper functions.
